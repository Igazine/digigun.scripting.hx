...
enum ExprDef {
    ...
    EClass(name:String, 
           ...
           methods:Array<{name:String, args:Array<{name:String, type:Null<TypeDecl>}>, retType:Null<TypeDecl>, body:Expr, isStatic:Bool, isPublic:Bool, ?meta:Array<{name:String, params:Array<Expr>}>}>, 
           ?parent:TypeDecl,
    ...
    EAbstract(name:String, underlyingType:TypeDecl, fields:Array<{name:String, type:Null<TypeDecl>, expr:Expr, isStatic:Bool, isPublic:Bool, isFinal:Bool, ?property:{get:String, set:String}, ?meta:Array<{name:String, params:Array<Expr>}>}>, methods:Array<{name:String, args:Array<{name:String, type:Null<TypeDecl>}>, retType:Null<TypeDecl>, body:Expr, isStatic:Bool, isPublic:Bool, ?meta:Array<{name:String, params:Array<Expr>}>}>, ?params:Array<String>, ?meta:Array<{name:String, params:Array<Expr>}>);
